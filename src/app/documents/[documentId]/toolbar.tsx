    ...
    <div className="flex items-center gap-x-0.5">
      ...
      {isEditing ? (
        <input
          ...
          className="h-7 w-10 text-sm text-center border border-neutral rounded-sm bg-transparent focus:outline-none focus:ring-0"
        />
      ) : (
        <button
          onClick={() => {
          ...
          className="h-7 w-10 text-sm text-center border border-neutral rounded-sm hover:bg-neutral-200/80"
        >
          {currentFontSize}
        </button>
      )}
